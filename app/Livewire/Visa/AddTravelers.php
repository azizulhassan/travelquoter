...
class AddTravelers extends Component implements HasForms, HasActions
{
    ...
    public $total_no_of_travelers = 0;

    public function render()
    {
        return view('livewire.visa.add-travelers');
    }
    ...
    public function mount() {
        ...
        if(session()->has('no_of_travelers')) {
            ...
            $this->children = $this->no_of_travelers['children'];
            $this->infants = $this->no_of_travelers['infants'];
            $this->adults = $this->no_of_travelers['adults'];

            $this->total_no_of_travelers = $this->no_of_travelers['adults'] + $this->no_of_travelers['infants'] + $this->no_of_travelers['children'];
        }
    }
    ...
    public function next()
    {
        ...
        $this->dispatch('travelers-added', session('no_of_travelers'));
