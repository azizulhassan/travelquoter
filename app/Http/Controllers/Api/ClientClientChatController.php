...
class ClientClientChatController extends Controller
{
    public function index()
    {
        return response([
            'chats' => ClientClientChat::where('status', true)->orderBy('created_at', 'DESC')->get()
        ], 200);
    }

    public function show($id)
    {
        $client_agent_chat = ClientClientChat::find($id);
