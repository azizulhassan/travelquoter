...
use App\Filament\Admin\Resources\FlightClassResource\Pages;
use App\Filament\Admin\Resources\FlightClassResource\RelationManagers;
...
class FlightClassResource extends Resource
{
            ...
            ->schema([
                Forms\Components\Section::make('')->schema([
                    ...
                    Forms\Components\TextInput::make('slug')
                        ...
                        ->dehydrated()
                        ->required()
                        ->unique(FlightClass::class, 'slug', ignoreRecord: true)->columnSpanFull()->inlineLabel(),
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewFlightClass::route('/{record}'),
