<div class="pb-12 pt-8 px-4">
    ...
    <div class="text-center">
        <p class="text-gray-700 mt-8">{{ __('Did not receive an verification mail. Then re-send a verification mail.') }}</p>
        <div class="mt-3 flex items-center gap-2 flex-wrap justify-center">
            <x-filament::button wire:click="resendVerificationMail">{{ __('Re-send verification mail') }}</x-filament::button>
