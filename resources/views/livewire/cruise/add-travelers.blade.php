<x-filament::modal id="add-travelers-modal">
    ...
    <div class="space-y-4">
        <p class="fw-semibold"><b>No of travelers</b></p>
        <label for='name'
        ...
        {{-- <label for='name' style="display: flex; align-items: center;"><span><b>Youths</b>

            <span class="p-style-sub">(Age 12-17)</span>
            </span>
            <span style="margin-left: auto;">
                <img src="{{ asset('assets/icons/sign.png') }}" alt="Icon Description">
                <span style="margin: 0px 4px;text-align: center;">
                    55
                </span>
                <img src="{{ asset('assets/icons/plus.png') }}" alt="Icon Description">
            </span>
        </label>
        <hr> --}}
