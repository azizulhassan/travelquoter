<nav id="floating-navbar-wrapper" x-data="" class="absolute w-full top-0 z-[9999]">
                    ...
                    @if (Auth::guard('client')->check())
                        <x-filament::dropdown size="lg" placement="top-start">
                            ...
                            <x-filament::dropdown.list>
                                <x-filament::dropdown.list.item icon="heroicon-s-user" tag="a" href="{{ route('filament.client.pages.dashboard', ['locale' => app()->getLocale(), 'tab' => 'my-information']) }}">
                                    My information
                                </x-filament::dropdown.list.item>

                                <x-filament::dropdown.list.item icon="heroicon-s-list-bullet" tag="a" href="{{ route('filament.client.pages.dashboard', ['locale' => app()->getLocale(), 'tab' => 'my-quotes']) }}">
                                    My quotes
                                </x-filament::dropdown.list.item>

                                <x-filament::dropdown.list.item icon="heroicon-s-user-group" tag="a" href="{{ route('filament.client.pages.dashboard', ['locale' => app()->getLocale(), 'tab' => 'g-trip']) }}">
                                    G-trip
                                </x-filament::dropdown.list.item>

                                <x-filament::dropdown.list.item icon="heroicon-s-check" tag="a" href="{{ route('filament.client.pages.dashboard', ['locale' => app()->getLocale(), 'tab' => 'subscriptions']) }}">
                                    Subscriptions
                                </x-filament::dropdown.list.item>

                                <x-filament::dropdown.list.item icon="heroicon-s-document-text" tag="a" href="{{ route('filament.client.pages.dashboard', ['locale' => app()->getLocale(), 'tab' => 'my-documents']) }}">
                                    My documents
                                </x-filament::dropdown.list.item>

                                <x-filament::dropdown.list.item icon="heroicon-s-bookmark" tag="a" href="{{ route('filament.client.pages.dashboard', ['locale' => app()->getLocale(), 'tab' => 'bookmarks']) }}">
                                    Bookmarks
                                </x-filament::dropdown.list.item>

                                <x-filament::dropdown.list.item icon="heroicon-s-cog-8-tooth" tag="a" href="{{ route('filament.client.pages.dashboard', ['locale' => app()->getLocale(), 'tab' => 'settings']) }}">
                                    Settings
                                </x-filament::dropdown.list.item>

                                <x-filament::dropdown.list.item icon="heroicon-s-banknotes" tag="a" href="{{ route('agent-membership', app()->getLocale()) }}">
                                    Become a Partner
                                </x-filament::dropdown.list.item>
                            </x-filament::dropdown.list>
                        </x-filament::dropdown>
