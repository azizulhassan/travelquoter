        ...
        <section>
            <div class="max-w-screen-xl px-3 md:px-8 mx-auto mt-12">
                <h1 class="font-bold text-2xl">
                    {{ __('GET THE') }} <span class="text-red-600">{{ __('VISA') }}</span> {{ __('EASY') }}
                </h1>
                <div>{{ __('Unlock seamless global travel with our streamlined visa services.') }}</div>
            </div>

            <div class="max-w-screen-xl px-3 md:px-8 mx-auto mt-10 mb-20">
                <livewire:visa.step1-form />
            </div>
        </section>
    </main>
@stop
