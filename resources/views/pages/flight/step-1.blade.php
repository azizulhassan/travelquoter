    ...
    <main>
        <section>
            <div class="max-w-screen-xl px-3 md:px-8 mx-auto mt-12">
                <h1 class="text-2xl font-bold">{{ __('Get Flight Quote') }}</h1>
        ...
        <section>
            <div class="max-w-screen-xl px-3 md:px-8 mx-auto mt-12">
                <h1 class="font-bold text-2xl">
                    {{ __('SEARCH TRAVEL') }} <span class="text-red-600">{{ __('PACKAGES') }}</span>
                </h1>
                <div>{{ __('Find a flexible flight for your next trip!') }}</div>
            </div>

            <div class="max-w-screen-xl px-3 md:px-8 mx-auto mt-10 mb-20">
                <livewire:flight.step1-form />
            </div>
        </section>
    </main>
@stop
