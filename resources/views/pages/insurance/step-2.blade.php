            ...
            <div class="max-w-screen-xl px-3 md:px-8 mx-auto mt-12">
                ...
                <ul class="flex items-center mt-3">
                    <li class="w-8 h-8 flex items-center justify-center rounded-full bg-[#E2E4E7] text-white">
                        <x-filament::icon class="w-4 h-4" icon="heroicon-o-check" />
                    </li>
                    <li>
                ...
                <div class="flex justify-between gap-2 flex-wrap">
                    <div>
                        <h1 class="font-bold text-2xl">
                            {{ __('SEARCH TRAVEL') }} <span class="text-red-600">{{ __('AGENTS') }}</span>
                        </h1>
                        <div>{{ __('Select travel agent you want to send your quote to.') }}</div>
                    </div>
                    <div>
                        <livewire:insurance.step2-filter-itinerary />
                    </div>
                </div>
            </div>

            <div class="max-w-screen-xl px-3 md:px-8 mx-auto mt-10 mb-20">
                <livewire:insurance.step2-filter />
            </div>
        </section>
    </main>
@stop
